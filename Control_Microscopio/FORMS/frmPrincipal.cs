...
//          }
      ...
      {
        this.textBox1.Text = this.textBox1.Text + Objeto.GetType().Name + '\n';
        FieldInfo[] fields = Objeto.GetType().GetFields();
        String str = "";
        foreach (FieldInfo f in fields)
        {
          str = "     " + f.Name + " = " + f.GetValue(Objeto) + '\n';
      ...
      delegate void ShowTextInfo_CallBack(string TextInfo);
      public void ShowTextInfo(string TextInfo)
      {
        ...
        try
        {
          ...
          {
            ShowTextInfo_CallBack d = new ShowTextInfo_CallBack(ShowTextInfo);
            this.Invoke(d, new object[] { TextInfo });
          }
          else
          {
            Program.frmMainForm.textBox1.Text = Program.frmMainForm.textBox1.Text + TextInfo +  '\r' +'\n';
          }
